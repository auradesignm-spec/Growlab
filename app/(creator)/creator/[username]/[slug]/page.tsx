...
export default async function CreatorProductSlugPage({
  ...
  const data = await getStorefrontDealBySlug(params.username, params.slug);
  if (!data) notFound();

  await recordStorefrontVisit(data.username, data.deal.dealId);
