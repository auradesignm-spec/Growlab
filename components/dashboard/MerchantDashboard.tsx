...
export default function MerchantDashboard({
  ...
  const primaryTabs: Array<{ id: Tab; label: string }> = [
    ...
    { id: "simulator", label: locale === "en" ? "Compliance Radar Simulator" : "محاكي رادار الامتثال والمخاطر" },
  ...
  function ShortcutsRow({
    ...
    const items: Array<{
      ...
      {
        id: "simulator",
        label: locale === "en" ? "Compliance Simulator" : "محاكي الامتثال",
        hint: locale === "en" ? "Test real-time risks & quotas" : "تجربة تدفق رصد التراخيص والتعمين",
