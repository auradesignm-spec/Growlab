...
ALTER TABLE "InterestLead" ADD COLUMN "nextFollowUpAt" DATETIME;
ALTER TABLE "InterestLead" ADD COLUMN "capiLeadAt" DATETIME;
ALTER TABLE "InterestLead" ADD COLUMN "capiPurchaseAt" DATETIME;
